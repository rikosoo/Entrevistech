    ...
    <div class="sufee-login d-flex align-content-center flex-wrap">
        <div class="container">
            <div class="login-content">
                ...
                <div class="alert alert-danger" style="margin-top: 10px; display: none" id="errormsg">
...
if (isset($_POST["submit1"])) {
    ...
    $res = mysqli_query($link, "select * from empresa where username='$username' && password='$password'");
